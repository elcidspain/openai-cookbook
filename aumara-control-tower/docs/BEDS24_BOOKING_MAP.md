...
2. `aumara-control-tower/scripts/beds24_open_booking_availability.py`
   ...
   - `POST /inventory/rooms/calendar` for rooms `674465` (CHALET, 3 units / €259) and `674466` (Superior, 2 / €329) from today through `2026-12-31`.
...
| --- | --- | --- | --- |
| V2 inventory | `/inventory/rooms/calendar` | `numAvail` open + daily `price1` | Live run 35378606405 SUCCESS for numAvail. Chalet capped to 3. Superior GET historically ~3 days until daily prices exist. |
...
| Recovery point | `cursor/beds24-v1-rack-rates-8cf4` then main after merge; rerun with `[open-availability]` |
