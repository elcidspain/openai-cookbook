...
- `.github/workflows/beds24-photo-sync-vault-controller.yml` — direct manual photo-vault transfer remains available; issue-triggered execution removed in P1.
...
- No guest-message/runtime workflow is changed by P1.
- No Beds24 workflow is executed by the cleanup itself.
